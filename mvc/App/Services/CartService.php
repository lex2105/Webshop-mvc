...
class CartService
{
    ...
    public static function remove(Product $product): array
    {
        ...
        if (self::has($product)) {
            ...
            /**
             * Ist der Counter für ein Product im Cart auf 0 gefallen, so entfernen wir das Product aus dem Cart.
             */
    ...
    /**
     * Alle Einheiten eines Product aus dem Cart entfernen.
     *
     * @param Product $product
     *
     * @return array
    ...
    public static function get(): array
    {
        ...
        foreach ($_SESSION[self::SESSION_KEY] as $productId => $number) {
            /**
             * ... jeweils das zugehörige Product aus der Datenbank laden, ...
             */
            ...
            /**
             * ... und "fertiges" Product Objekt in das vorbereitete Array speichern.
             */
            $products[] = $product;
        }

        /**
         * Liste aller Products aus dem Cart zurückgeben.
         */
        return $products;
    }
    ...
    /**
     * Convenience Function zur Prüfung, ob ein Product bereits im Cart liegt oder nicht.
     *
     * @param Product $product
     *
     * @return bool
