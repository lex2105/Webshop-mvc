<header class="header">
    <div class="header__one">
        ...
        <div class="header__one__search">
            <form action="<?php echo BASE_URL; ?>/search" method="post">
                <input type="text" placeholder="Search all products..." name="search" class="search">
    ...
    <nav>
        <button class="main__nav__button">
            <span class="sr-only">Menu</span>
            <svg class="main__nav__burger" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 124 124">
        ...
        <?php if (\Core\Middlewares\AuthMiddleware::isAdmin()) : ?>
            <a href="<?php echo BASE_URL; ?>/products/create">Admin</a>
        <?php endif; ?>
    </nav>
</header>